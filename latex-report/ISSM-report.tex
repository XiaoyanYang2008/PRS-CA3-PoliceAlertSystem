...
\begin{figure}[ht]
	...
	\end{tabular}}
	\caption{Autoencoder network.\label{figure10}}
\end{figure}
\begin{figure}[ht]
	\centerline{\begin{tabular}{c}
			\includegraphics[width=7cm]{pic/autoencoder-training-summary.png}
	\end{tabular}}
	\caption{Autoencoder network training and its structure\label{figure11}}
\end{figure}

By training autoencoder network with non gun shots sound data, we hope that gun shots sound will be recognized as anomaly to the network. Due to 4 seconds and sampling rate of 22kHz, our data will be 1D arrary of 88.200k samples. From Fig. \ref{figure11}, layer1, which is the innermost layer of undercomplete autoencoder neural network, it has only 8 neurons.
...
\begin{figure}[ht]
	...
	\end{tabular}}
	\caption{Auto encoder performance analysis code snipet\label{figure12}}
\end{figure}
...
\begin{figure}[ht]
	...
	\end{tabular}}
	\caption{Autoencoder performance analysis\label{figure13}}
\end{figure}

With threshold of 62.17 in Fig. \ref{figure13}, we found out that only 4.2\% of training data is anomaly, whereas gun shot data anomaly rate is about 30.48\% at 95\% confidence level. 
...
\begin{figure}[ht]
	...
	\end{tabular}}
	\caption{Autoencoder with 800 innermost layer \label{figure14}}
\end{figure}
...
\begin{figure}[ht]
	...
	\end{tabular}}
	\caption{Performance of Autoencoder with 800 innermost layer \label{figure15}}
\end{figure}
...
Long short-term memory neural network is another typical tool to handle 1D time series data. Below is the network structure we deploy for classification model training.
\begin{figure}[ht]
	\centerline{\begin{tabular}{c}
			\includegraphics[width=7cm]{pic/autoencoder-800-performance.png}
	\end{tabular}}
