...
The sounds are of various sampling rate as well as sampling rate. We utilize librose to convert sampling rate to 22kHz and mono channel. As for sound duration that's less than 4 seconds, we concatenates the sound itself until it fills up the 4 seconds duration.
...
\begin{figure}[tbh]
	...
	\end{tabular}}
	\caption{self repeating to fill up to 4 seconds.\label{figure1}}
\end{figure}
