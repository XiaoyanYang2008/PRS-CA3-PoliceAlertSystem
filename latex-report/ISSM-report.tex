...
\begin{figure}[h]
	\centerline{\begin{tabular}{cc|c}
			\includegraphics[width=7cm]{figures/data-loading.png}
	\end{tabular}}
...
\begin{figure}[h]
	\centerline{\begin{tabular}{cc|c}
			\includegraphics[width=7cm]{figures/self-repeatUntil4secs.png}
	\end{tabular}}
...
\begin{figure}[h]
	\centerline{\begin{tabular}{cc|c}
			\includegraphics[width=7cm]{figures/plotAndPlaySounds.png}
	\end{tabular}}
...
\begin{figure}[h]
	\centerline{\begin{tabular}{cc|c}
			\includegraphics[width=7cm]{figures/auto-encoder-network.png}
	\end{tabular}}
	\caption{Auto encoder network.\label{figure4}}
\end{figure}
\begin{figure}[h]
	\centerline{\begin{tabular}{cc|c}
			\includegraphics[width=7cm]{figures/autoencoder-training-summary.png}
	\end{tabular}}
	\caption{Auto encoder network training and its structure\label{figure5}}
\end{figure}

By training Auto encoder network with non gun shots sound data, we hope that gun shots sound will be recognized as anomaly to the network. Due to 4 seconds and sampling rate of 22kHz, our data will be 1D arrary of 88.200k samples. From Fig. \ref{figure5}, layer1, which is the innermost layer of under complete neural network, it has only 8 neurons. However, the performance may not be bad than network with more neurons, which we will share more later.

The code to analysis performance of training data and gun shot(noise, test) anomaly detection is as below. 

\begin{figure}[h]
	\centerline{\begin{tabular}{cc|c}
			\includegraphics[width=7cm]{figures/autoencoded-8-31.png}
	\end{tabular}}
...
\begin{figure}[h]
	\centerline{\begin{tabular}{c}
			\includegraphics[width=7cm]{figures/autoencoder-8-31-result.png}
	\end{tabular}}
	\caption{Auto encoder performance analysis\label{figure7}}
\end{figure}

With threshold of 62.17, we found out that only 4.2\% of training data is abnormal, whereas gun shot data anomaly rate is about 30.48\% at 95\% confidence level.
